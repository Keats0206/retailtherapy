...
export function WatchLayout({
  ...
  const { pinned, trail, votesFor, myVotes, vote } = stream;
          ...
          <Sheet>
            ...
            <SheetTrigger
              className={cn(
                ...
                "pointer-events-auto relative rounded-full border-white/30 bg-black/40 text-white backdrop-blur-sm hover:bg-black/60 hover:text-white",
              )}
